...
from AnieXEricaMusic.utils.formatters import convert_bytes
from AnieXEricaMusic.utils.inline.song import song_markup

# Command
SONG_DOWNLOAD_DURATION = int("9999")
SONG_DOWNLOAD_DURATION_LIMIT = int("9999")
